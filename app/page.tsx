            ...
            <Card className="h-full transition-colors hover:border-primary hover:bg-muted/50 cursor-pointer">
              <CardHeader className="space-y-3">
                ...
                <div>
                  ...
                  <CardDescription>Consultez la documentation produit et accédez à l'espace partagé.</CardDescription>
                </div>
              </CardHeader>
            </Card>
          </Link>
            ...
            <Card className="h-full transition-colors hover:border-primary hover:bg-muted/50 cursor-pointer">
              <CardHeader className="space-y-3">
                ...
                <div>
                  ...
                  <CardDescription>Suivez vos demandes de retour et créez de nouvelles demandes.</CardDescription>
                </div>
              </CardHeader>
            </Card>
          </Link>
            ...
            <Card className="h-full transition-colors hover:border-primary hover:bg-muted/50 cursor-pointer">
              <CardHeader className="space-y-3">
                ...
                <div>
                  ...
                  <CardDescription>Monitoring et reporting de l'ensemble des activités.</CardDescription>
                </div>
              </CardHeader>
            </Card>
          </Link>
